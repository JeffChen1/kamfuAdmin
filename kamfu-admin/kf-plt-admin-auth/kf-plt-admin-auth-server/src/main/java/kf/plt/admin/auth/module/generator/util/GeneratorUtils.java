...
package kf.plt.admin.auth.module.generator.util;
...
public class GeneratorUtils {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        map.put("package", "kf.plt.admin.generate");
        map.put("author", "老");
        map.put("email", "A463540703@qq.com");
        map.put("description", "自动化工程");
        // 决定服务名\maven模块名\主文件夹名
        map.put("clientId", "kf-plt-admin-demo-generator");
