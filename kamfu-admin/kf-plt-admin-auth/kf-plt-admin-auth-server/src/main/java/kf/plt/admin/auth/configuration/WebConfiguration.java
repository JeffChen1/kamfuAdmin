...
package kf.plt.admin.auth.configuration;

import kf.plt.admin.auth.interceptor.ServiceAuthRestInterceptor;
import kf.plt.admin.auth.interceptor.UserAuthRestInterceptor;
