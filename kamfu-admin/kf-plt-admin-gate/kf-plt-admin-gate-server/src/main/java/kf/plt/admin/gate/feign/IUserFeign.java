...
package kf.plt.admin.gate.feign;

import kf.plt.admin.intf.api.vo.authority.PermissionInfo;
import kf.plt.admin.gate.config.FeignConfiguration;
 ...
 */
@FeignClient(value = "kf-plt-admin-sysmgnt",configuration = FeignConfiguration.class)
