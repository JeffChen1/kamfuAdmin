...
package kf.plt.admin.gate.filter;

import com.alibaba.fastjson.JSON;
import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import kf.plt.admin.auth.client.config.ServiceAuthConfig;
import kf.plt.admin.auth.client.config.UserAuthConfig;
import kf.plt.admin.auth.client.jwt.ServiceAuthUtil;
import kf.plt.admin.auth.client.jwt.UserAuthUtil;
import kf.plt.admin.common.exception.auth.NonLoginException;
import kf.plt.admin.common.exception.auth.UserForbiddenException;
import kf.plt.admin.common.util.ClientUtil;
import kf.plt.admin.gate.feign.ILogFeign;
import kf.plt.admin.gate.feign.IUserFeign;
import kf.plt.admin.gate.utils.DBLog;
import kf.plt.admin.intf.api.vo.authority.PermissionInfo;
import kf.plt.admin.intf.api.vo.log.LogInfo;
